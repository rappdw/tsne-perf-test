...
def run_test(venv, tsne_dir, outfile, python_test_output):
    ...
    if python_test_output:
        ...
        python_command  = 'source {}; cd /sandbox; /usr/bin/time -f "%e %M %P" -o {} ./python-tsne-perf-test.py /sandbox/data.dat'.format(venv, python_test_output)
...
if __name__ == '__main__':
    ...
    comparisons = [
        ...
        ('/.venv/bin/activate', None, None, '/sandbox/py.time.tsne-cuda.out'),
